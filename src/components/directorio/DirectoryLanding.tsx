      ...
      <main id="contenido-directorio">
        ...
        <section className="bg-white px-4 py-8 sm:px-6 sm:py-12">
          <div className="mx-auto max-w-6xl overflow-hidden rounded-[2rem] bg-[#004e28] px-5 py-12 text-center text-white shadow-[0_28px_80px_-45px_rgba(0,78,40,0.9)] sm:px-10 sm:py-16">
            ...
            <Link href={registerHref} onClick={() => handleCtaClick("final")} aria-disabled={!plan} className={`group mt-10 inline-flex items-center justify-center gap-2.5 rounded-full bg-white px-10 py-[14px] text-base font-bold text-[#004e28] shadow-[0_8px_30px_-6px_rgba(0,0,0,0.25)] transition-all duration-250 ease-out hover:-translate-y-0.5 hover:shadow-[0_14px_40px_-6px_rgba(0,0,0,0.35)] hover:bg-[#eef5ec] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#004e28] sm:text-lg ${!plan ? "pointer-events-none opacity-65" : ""}`}>Registrar mi negocio <ArrowRight size={20} className="transition-transform duration-250 ease-out group-hover:translate-x-1" aria-hidden="true" /></Link>
