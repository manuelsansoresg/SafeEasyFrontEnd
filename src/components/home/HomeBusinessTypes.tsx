...
export function HomeBusinessTypes({
  ...
  return (
    <section aria-labelledby="explore-businesses-title" className="relative py-8">
      ...
      <div ref={scroller} className="-mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-3 scrollbar-thin md:mx-0 md:grid md:grid-cols-3 md:gap-x-6 md:gap-y-5 md:overflow-visible md:px-0 md:pb-0 lg:grid-cols-6">
        <button type="button" aria-pressed={!selectedSlug && initialIsDirectory === undefined} onClick={() => select(null)} className="group flex w-32 shrink-0 snap-start flex-col items-center gap-2 rounded-2xl px-2 py-3 text-center transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#168e00]/40 md:w-auto md:px-3 md:py-4">
