...
const steps = [
  ...
  },
  {
    ...
    desc: "Tu solicitud queda pendiente durante el periodo de seguridad.",
    icon: Clock,
  },
  {
    num: 3,
...
export default function AccountDeletePage() {
  ...
  useEffect(() => {
    if (hasHydrated && !token) {
      router.replace("/login?redirect=/account/delete/confirm");
    }
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                  Gestiona la eliminación permanente de tu cuenta de Drooopy.
                </p>
              </div>
            </div>
          </div>
